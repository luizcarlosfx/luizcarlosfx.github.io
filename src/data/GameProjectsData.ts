...
export const mainProjects = [
    ...
    `
    <div class="paragraph">
        <strong>XRProj</strong> is a multi-platform XR content creation system that lets teams bring CAD projects into VR (PC and Quest), AR (Android and iOS), HoloLens, and WebGL, all from a single unified pipeline.
    </div>
    <div class="paragraph">
        As <strong>Lead Developer and Architect</strong>, I built this project from initial concept through nearly four years of continuous development, including real-time networking, serialization, and cross-platform deployment.
    </div>
    <div class="paragraph">
        Engineers at <strong>Embraer</strong> use it to review aircraft assembly steps on Quest headsets. <strong>Nestl&eacute;, Ball Corporation, and Aegea</strong> use it for CAD visualization, assembly validation, and collaborative design review. In active development and production use since 2019.
    </div>
    ...
    `
    <div class="paragraph">
        <strong>XRTracker</strong> is a markerless 3D object tracking SDK for Unity that delivers <strong>6DOF pose estimation with sub-centimeter precision</strong> (no scanning, markers, or cloud training required). A factory worker can point their phone at an engine part and see step-by-step overlay instructions for assembly.
    </div>
    <div class="paragraph">
    ...
    `
    <div class="paragraph">
        <strong>Virtua</strong> is a VR medical training platform developed for <strong>Becton Dickinson (BD)</strong>, a multinational healthcare company. Nurses put on a headset and practice central venous catheter insertion in VR before touching a real patient. BD sales reps also use it to demo their catheter kits to hospital procurement teams. In production since 2021, currently used by BD across <strong>Brazil, Mexico, Colombia, Argentina, and Chile</strong>.
    </div>
    <div class="paragraph center">
    ...
    <div class="paragraph">
        A <strong>full-stack educational platform</strong> built for <strong>FormulaXR</strong> that hosts 40+ interactive science simulations powered by Unity. A student can drag atoms to build molecules, walk through a virtual ecosystem to understand food chains, or explore an interactive periodic table.
    </div>
    <div class="paragraph">
    ...
    `
    <div class="paragraph">
        <strong>OrtoVR</strong> is a VR training application developed for <strong>Ortos&iacute;ntese</strong>, a Brazilian orthopedic company. Surgeons put on a headset and practice placing implants and handling surgical instruments in VR before entering the operating room. Featured as a key demonstration at a major healthcare fair in 2018.
    </div>
    <div class="paragraph center">
    ...
    `
    <div class="paragraph">
        A <strong>proof-of-concept</strong> developed for <strong>Hospital Benefic&ecirc;ncia Portuguesa de S&atilde;o Paulo (BP)</strong>, one of Brazil's most prestigious healthcare institutions, recognized among the world's best hospitals for seven consecutive years. The surgeon wears a VR headset and controls a real robotic arm to perform simulated surgical procedures, with the arm responding to their hand movements in real time.
    </div>
    <div class="paragraph center">
    ...
    `
    <div class="paragraph">
        A <strong>multi-user virtual classroom</strong> developed in collaboration with the City Hall of S&atilde;o Jos&eacute; dos Campos, Brazil. Students wearing VR headsets join the same virtual classroom from different locations and attend interactive lessons together. This project laid the foundation for several core systems I continue to use across my VR projects today.
    </div>
    <div class="paragraph center">
    ...
    <div class="paragraph">
        A <strong>VR forklift training simulator</strong> developed for <strong>Nestl&eacute;</strong>. Before driving a real forklift at the warehouse, operators put on a Quest headset and go through every safety step in VR: pre-operation inspection, environment awareness, and load handling. The system evaluates whether each step is performed correctly in real time.
    </div>
    <div class="paragraph">
    ...
    <div class="paragraph">
        A <strong>multi-user VR simulation</strong> of an industrial painting machine, developed for a major multinational corporation. One team member wears a VR headset to walk around the virtual machine, while colleagues on their laptops observe and annotate from their desks. Both <strong>VR and desktop users</strong> share the same environment in real time.
    </div>
    <div class="paragraph center">
...
export const minorProjects = [
    ...
    <div class="paragraph">
        VR experience developed for <strong><a href="https://www.climatempo.com.br/" target="_blank">Climatempo</a></strong> and <strong>Kersys</strong> for the <strong>RM Vale 2016</strong> event. I did <strong>full development</strong> of the application. Interactive scenes let users explore weather and environmental data in VR.
    </div>
    <div class="paragraph center">
